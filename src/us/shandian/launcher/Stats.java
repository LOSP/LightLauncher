...
public class Stats {
    ...
    public static final String ACTION_LAUNCH = "us.shandian.launcher.action.LAUNCH";
    public static final String PERM_LAUNCH = "us.shandian.launcher.permission.RECEIVE_LAUNCH_BROADCASTS";
